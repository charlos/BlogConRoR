...
gem 'execjs'
gem 'therubyracer', :platforms => :ruby
# Para hacer loggin de usuarios
gem "devise"
# para convertir una peticio html en AJAX y resolverla por DOM
# de esta manera se evita recargar la pág.
gem 'jquery-turbolinks'
# para manipular archivos
gem 'paperclip'
# para implementar "maquina de estados"
gem 'aasm'
